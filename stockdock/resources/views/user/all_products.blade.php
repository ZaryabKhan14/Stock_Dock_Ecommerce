                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                           ...
                           @endphp
                                <div class="product__item__pic " style="background-image: url('{{ asset('product_images/' . $firstImage) }}');" alt="{{ $product->product_name }}">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="{{asset('user_assets/img/icon/heart.png')}}" alt=""></a></li>
                                        <li><a href="#"><img src="{{asset('user_assets/img/icon/compare.png')}}" alt=""> <span>Compare</span></a>
                                        </li>
                                ...
                                <div class="product__item__text">
                                    ...
                                    <a href="{{ route('show_product_details', ['id' => $product->id]) }}" class="add-cart">+ View Details</a>
                                    <div class="rating">
                                    ...
                                    @foreach($product->product_colour as $color)
        @php
            // Check if color is a predefined class
            $colorClass = in_array($color, ['red', 'blue', 'purple']) ? $color : '';
        @endphp
                                        <label for="pc-4">
                                            <input type="radio" id="pc-4" class="color {{ $colorClass }}" style="{{ $colorClass ? '' : 'background-color: ' . $color . ';' }}" data-color="{{ $color }}" onclick="selectColor(this)" data-toggle="tooltip" title="{{ $color }}">
                                        </label>
