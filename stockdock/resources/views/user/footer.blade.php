 ...
 <footer class="footer">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{asset('user_assets/img/footer-logo.png')}}" alt=""></a>
                        </div>
                        <p>The customer is at the heart of our unique business model, which includes design.</p>
                        <a href="#"><img src="{{asset('user_assets/img/payment.png')}}" alt=""></a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="footer__widget">
                        <h6>Shopping</h6>
                        <ul>
                            <li><a href="{{route('contact_us_form')}}">Contact Us</a></li>
                ...
                <div class="col-lg-12 text-center">
                    <div class="footer__copyright__text">
                        ...
                        <p>Copyright ©
                            ...
                            All rights reserved By Stock Dock <i class="fa fa-heart-o"
                        </p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
    ...
    <script src="{{asset('user_assets/js/jquery.nicescroll.min.js')}}"></script>
    ...
    <script src="{{asset('user_assets/js/mixitup.min.js')}}"></script>
